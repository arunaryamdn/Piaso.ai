  ...
  return (
    <div className="main-content">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', width: '100%' }}>
        <h1 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#fff', margin: 0 }}>News Feed</h1>
      ...
      <div className="relative flex min-h-screen flex-col bg-[#162013] font-[Manrope, Noto Sans, sans-serif]">
        ...
        <main className="flex flex-1 gap-8 px-8 py-6">
          ...
          <section className="flex flex-col flex-1">
            ...
            <div className="space-y-5 fadeInUp">
              ...
              {filtered.map((article, i) => (
                <article key={i} className="news-article-card flex gap-5 bg-[#1A2615] p-5 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 ease-in-out">
                  <img
                    alt={article.title}
