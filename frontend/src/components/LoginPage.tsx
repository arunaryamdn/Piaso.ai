        ...
        <div className="min-h-screen flex items-center justify-center bg-[#162013] px-4 relative overflow-hidden">
            ...
            >
                <div className="flex flex-col items-center mb-6">
                    ...
                    <span className="text-[#A2C398] text-sm text-center">Smarter investing starts here.</span>
                </div>
                <h2 className="text-2xl font-bold text-white mb-4">Sign in to your account</h2>
                ...
                <div className="flex items-center my-6 w-full">
                    ...
                    <span className="mx-4 text-[#A2C398] text-xs">or sign in with</span>
                    <div className="flex-1 h-px bg-[#2E4328]" />
                </div>
